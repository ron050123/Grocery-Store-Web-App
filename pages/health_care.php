...
// fetch all products in the "Health & Care" category
$query = "SELECT * FROM products WHERE product_name IN ('Panadol', 'Bath Soap', 'Washing Powder', 'Laundry Bleach', 'Garbage Bags Small', 'Garbage Bags Large')";

// selected category
if ($category) {
    if ($category == 'medicines') {
        $query .= " AND product_name IN ('Panadol')";
    } elseif ($category == 'personal_hygiene') {
        $query .= " AND product_name IN ('Bath Soap')";
    } elseif ($category == 'laundry_cleaning') {
        $query .= " AND product_name IN ('Washing Powder', 'Laundry Bleach', 'Garbage Bags Small', 'Garbage Bags Large')";
    }
}
